<?php
    ...
    $sql = "SELECT user_table.first_name, commentDate, comment_text FROM `comments_table`,`user_table` WHERE user_table.user_id = comments_table.user_id AND report_id='" .$id. "'";
